...
public class Driver extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
	    ...
	    Job job = Job.getInstance(conf, "Cellphone traffic calculation");
		...
		job.setMapperClass(CellphoneTrafficMapper.class);
		logger.info("mapper class is " + job.getMapperClass());
		
		job.setMapOutputKeyClass(Text.class);
		job.setMapOutputValueClass(CellphoneTraffic.class);
		...
		job.setReducerClass(CellphoneTrafficReducer.class);
		logger.info("reducer class is " + job.getReducerClass());
		job.setCombinerClass(CellphoneTrafficReducer.class);
		logger.info("combiner class is " + job.getCombinerClass());

		job.setOutputKeyClass(Text.class);
		job.setOutputValueClass(CellphoneTraffic.class);
		...
		job.setOutputFormatClass(job.getOutputFormatClass());
